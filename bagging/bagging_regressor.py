# Created by trilo at 29-08-2024
import numpy as np
...
if st.sidebar.button('Run Algorithm'):
    ...
    bag_reg = BaggingRegressor(algo, n_estimators=n_estimators, max_samples=max_samples,
                               bootstrap=bootstrap_samples).fit(X_train, y_train)
