...
estimators = st.sidebar.selectbox(
    ...
    placeholder="Select base estimator"
)

n_estimators = int(st.sidebar.number_input('Enter number of estimators', value=1))
...
if st.sidebar.button('Run Algorithm'):
    ...
    bag_clf = BaggingClassifier(estimator
                                ...
                                max_samples=max_samples, bootstrap=bootstrap_samples, max_features=max_features,
                                bootstrap_features=bootstrap_features, random_state=42)
